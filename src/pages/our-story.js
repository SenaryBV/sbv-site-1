          ...
          <div className="Team">
            ...
            <div className="Grid">
              ...
              <div className="Column Column--75">
                ...
                <p>In his time at MediaMath, Jonah quickly accrued a portfolio of key products - including various distributed systems related to digital identity.</p>
                ...
                <p>Though his first foray into blockchain was focused just on leveraging decentralized computational infrastructure, Jonah’s since grown passionate about DAOs, decentralized content networks, and crypto-economic systems that promote self-sovereignty, openness, and that work to remedy structural inequities.</p>
                <p>Jonah’s thrilled to join SBV with great friends, and grateful to be contributing to this critically important new era for public computing.</p>
                <p>In his spare time, Jonah enjoys outdoor activities, trading on dydx and farming a bit of yield. He lives where the wind takes him, always close to his family. He’s very proud of his two younger brothers.</p>
              </div>
            </div>
          </div>
        </div>
