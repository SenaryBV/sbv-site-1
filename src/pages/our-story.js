          ...
          <div className="Team">
            ...
            <div className="Grid">
              ...
              <div className="Column Column--75">
                ...
                <p>Lidsky lives in Windermere with his wife Dorothy and their four children. For his full bio, visit his website.</p>
              </div>
            </div>
            {/* Second Teammate */}
            <div className="Grid">
            ...
            <div className="Grid">
              ...
              <div className="Column Column--75">
                ...
                <p>Though his first foray into blockchain was focused just on leveraging distributed computational systems, Jonah’s since grown passionate about DAOs, decentralized content networks, and crypto-economic systems that promote self-sovereignty, openness, and that work to remedy structural inequities. </p>
